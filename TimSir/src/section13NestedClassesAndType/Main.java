package section13NestedClassesAndType;

import section13NestedClassesAndType.domain.Employee;
import section13NestedClassesAndType.domain.StoreEmployee;
...
//        employees.sort(comparator);
        ...
        // Employee's name are in sorted order
        ...
        // Employee's year of started are in sorted order
        ...
        System.out.println("-".repeat(30));
        // Employee's IDs are in sorted order
        ...
        List<StoreEmployee> storeEmployees = new ArrayList<>(List.of(
                ...
                new StoreEmployee(10322, "Danish", 2016, "Target")));
