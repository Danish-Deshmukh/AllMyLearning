package section13NestedClassesAndType.LocalClassChallenge;


import section13NestedClassesAndType.LocalClassChallenge.domain.Employee;
...
public class Main {
    ...
    public static void printOrderedList(List<Employee> eList, String sortField) {
        ...
        class MyEmployee {
            ...
            Employee contaiendEmployee;
            int yearWorked;
            String fullName;

            public MyEmployee(Employee contaiendEmployee) {

                this.contaiendEmployee = contaiendEmployee;
                yearWorked = currentYear - Integer.parseInt(
                        contaiendEmployee.hireDate().split("/")[2]);
                fullName = String.join(" ",
                        contaiendEmployee.firstName(),contaiendEmployee.lastName());
            }
